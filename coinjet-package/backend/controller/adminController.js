    ...
    if (adminData.isSuperAdmin) {
      const aggregateQuery = [
        ...
        },
        {
          $group: {
            _id: null,
            allAddFundHistory: { $push: "$addFundHistory" }
          }
        },
        {
          $project: {
        ...
        {
          $unwind: "$allAddFundHistory"
        },
        {
          $sort: {
            "allAddFundHistory.createdAt": -1
          }
        },
        {
          $group: {
            _id: null,
            allAddFundHistory: { $push: "$allAddFundHistory" }
          }
        },
        {
          $project: {
      ...
      if (result) {
        res.status(200).json({result, msg: "Successfully get users fund history!" });
      }
    ...
    if (adminData.isSuperAdmin) {
      const aggregateQuery = [
        ...
        },
        {
          $group: {
            _id: null,
            allCapitalWithdrawHistory: { $push: "$capitalWithdrawHistory" }
          }
        },
        {
          $project: {
            _id: 0,
            allCapitalWithdrawHistory: 1
          }
        },
        {
          $unwind: "$allCapitalWithdrawHistory"
        },
        {
          $sort: {
            "allCapitalWithdrawHistory.createdAt": -1
          }
        },
        {
          $group: {
            _id: null,
            allCapitalWithdrawHistory: { $push: "$allCapitalWithdrawHistory" }
          }
        },
        {
          $project: {
      ...
      if (result) {
        res.status(200).json({result, msg: "Successfully get users allCapitalWithdrawHistory!" });
      }
    ...
    if (adminData.isSuperAdmin) {
      const aggregateQuery = [
        ...
        },
        {
          $group: {
            _id: null,
            allWalletWithdrawHistory: { $push: "$walletWithdrawHistory" }
          }
        },
        {
          $project: {
            _id: 0,
            allWalletWithdrawHistory: 1
          }
        },
        {
          $unwind: "$allWalletWithdrawHistory"
        },
        {
          $sort: {
            "allWalletWithdrawHistory.createdAt": -1
          }
        },
        {
          $group: {
            _id: null,
            allWalletWithdrawHistory: { $push: "$allWalletWithdrawHistory" }
          }
        },
        {
          $project: {
      ...
      if (result) {
        res.status(200).json({result, msg: "Successfully get users allWalletWithdrawHistory!" });
      }
